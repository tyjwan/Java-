                ...
                // 根据(e.hash & oldCap)条件对链表进行拆分并放到newTable
                    ...
                    do {
                      ...
                      */
                        ...
                        // 根据上面的描述，这是index为原索引的情况，采用尾插法（1.7是头插法）
...
![image-20210111143251710](C:\Users\tyj\Desktop\Java工程师学习笔记\源码分析\image\HashMap(java8 resize).png)
...
4. hash分布均匀情况下两者的性能对比：
   ...
   ![image-20210111144252005](C:\Users\tyj\Desktop\Java工程师学习笔记\源码分析\image\hash分布均匀情况下对比.png)

5. hash分布不均匀情况下两者的性能对比：

   ![image-20210111144353331](C:\Users\tyj\Desktop\Java工程师学习笔记\源码分析\image\hash分布不均匀情况下对比.png)
